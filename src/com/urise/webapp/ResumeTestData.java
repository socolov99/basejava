...
public class ResumeTestData {
    public static void main(String[] args) {
        ...
        Section objectiveData = new SingleLineSection("Ведущий стажировок и корпоративного обучения по Java Web и Enterprise технологиям");
        Section personalData = new SingleLineSection("Аналитический склад ума, сильная логика, креативность, инициативность. Пурист кода и архитектуры.");
        ...
        Section achievementData = new BulletedListSection(achievements);
        ...
        Section qualificationData = new BulletedListSection(qualifications);
        ...
        Section experienceData = new OrganizationListSection(workOrganizations);
        ...
        Section educationData = new OrganizationListSection(educationalOrganizations);
